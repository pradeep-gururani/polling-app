      ...
      <div className="admin row">
        <div className="col-sm-9">
          <Switch>
            ...
            <Route path="/Admin/AddPoll" component={AddPoll} />
        ...
        <div className="col-sm-3 sidebar">
          ...
          <Link to="/Admin/ListUsers">
            <button className="btn btn-primary mb-2">All Users</button>
          </Link>
          <Link to="/Admin/AddPoll">
            <button className="btn btn-primary mb-2">Add Poll</button>
          </Link>
          <Link to="/Admin/ListPolls">
            <button className="btn btn-primary mb-2">All Polls</button>
          </Link>
          <Link to="/">
            <button
